...
!define INSTALLER_NAME "C:\Program Files (x86)\NSIS\Script Generator\Output\SAM\setup.exe"
...
InstallDir "$PROGRAMFILES\Coolcord\SAM"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Coolcord\SAM"
...
File "C:\Installer\Files\UPDATES AND SOURCE CODE.TXT"
...
CreateDirectory "$SMPROGRAMS\Coolcord\SAM"
CreateShortCut "$SMPROGRAMS\Coolcord\SAM\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Coolcord\SAM\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Coolcord\SAM\${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Coolcord\SAM\${APP_NAME} Website.lnk"
!endif
RmDir "$SMPROGRAMS\Coolcord\SAM"
!endif
